...
Once you have created the JWT, you can look at its internal structure by logging it to the console.
...
If you are going to use multiple signing keys, it is common practice to create a random ID which
